...
class HoneyProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HoneyProduct
        fields = ['id', 'brand', 'brand_id', 'name', 'badge', 'bottle_size_ml', 'price', 'photo', 'integrity_text', 'display_order', 'created_at', 'updated_at']

class HoneyBatchSerializer(serializers.ModelSerializer):
    honey_product = HoneyProductSerializer(read_only=True)
    honey_product_id = serializers.PrimaryKeyRelatedField(queryset=HoneyProduct.objects.all(), source='product', write_only=True, required=False)

    class Meta:
        model = HoneyBatch
        fields = ['id', 'live_harvest', 'live_harvest_id', 'batch_id', 'brand', 'honey_product', 'honey_product_id', 'quantity', 'weight', 'status', 'created_at', 'updated_at']
...
class CustomerAddressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'address', 'source', 'confidence', 'created_at', 'updated_at']
